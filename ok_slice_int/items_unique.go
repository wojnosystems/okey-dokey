...
func defaultItemsUniqueFormat(definition *ItemsUnique, value []optional.Int, duplicateIndexes []int) string {
	sb := strings.Builder{}
...
type ItemsUnique struct {
	Format func(definition *ItemsUnique, value []optional.Int, duplicateIndexes []int) string
}

func (m *ItemsUnique) Validate(value []optional.Int, violationReceiver bad.Emitter) ok_action.Enum {
